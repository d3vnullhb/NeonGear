    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center justify-between mt-2">
                    <div className="flex items-center gap-0" style={{ border: '1px solid var(--border)', borderRadius: 6, overflow: 'hidden' }}>
                      <button onClick={() => item.quantity > 1 ? updateItem(item.id, item.quantity - 1) : null} style={{ background: 'var(--surface-raised)', border: 'none', color: 'var(--text)', cursor: 'pointer', width: 28, height: 28, fontSize: 16 }}>−</button>
          ...
          <button onClick={clearCart} className="text-sm" style={{ color: 'var(--error)', background: 'none', border: 'none', cursor: 'pointer' }}>Xoá tất cả</button>
        </div>
